...
def start_query_ui(persistent_directory, args):
    ...
    selected = Prompt.ask("Enter the number of your choice", choices=[str(i) for i in range(1, len(models)+1)], default="1")
    ...
    while True:
        ...
        # Help command
            ...
            console.print("  [bold yellow]model[/bold yellow] - Change the LLM for summaries")
            continue
        ...
        # Model selection command
            ...
            for idx, model in enumerate(models, 1):
                console.print(f"  {idx}. {model}")
            selected = Prompt.ask("Enter the number of your choice", 
