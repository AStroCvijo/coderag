...
def retrieve(state, retriever):
    ...
    # Replace the document's content with the actual content from the source file
...
def generate(state, rag_chain, llm):
    ...
    generation = rag_chain.invoke({"context": trimmed_documents, "question": question})

    return {"documents": trimmed_documents, "question": question, "generation": generation}
...
# Function for deciding whether to generate an answer or handle an out-of-scope question
